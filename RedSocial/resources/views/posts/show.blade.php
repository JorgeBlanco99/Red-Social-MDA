...
<div class="container">
    <div class="row">
        ...
        <div class="col-4">
            ...
            @can('like', $post)
            <form action="/dislike/{{ $post->id }}" method="get" style="padding-bottom: 12px;">
                <button style="border-width: 0px; background-color: white; display:flex;" @click="likeUser">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5106 6.17642C9.36526 3.98237 5.83504 3.98237 3.68975 6.17642C1.61156 8.30184 1.61155 11.698 3.68974 13.8234L10.7889 21.0839C11.4534 21.7635 12.5469 21.7635 13.2114 21.0839L20.3106 13.8234C22.3887 11.698 22.3887 8.30184 20.3106 6.17642C18.1653 3.98237 14.635 3.98237 12.4897 6.17642L12.0001 6.67715L11.5106 6.17642Z" fill="black"/>
                    </svg>
            ...
            @endcan
            @cannot('like', $post)
            <form action="/like/{{ $post->id }}" method="get" style="padding-bottom: 12px;">
                <button style="border-width: 0px; background-color: white; display:flex;" @click="likeUser">
                    <svg style="margin-right:8px;" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
